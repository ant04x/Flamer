...
/*  static final Map<String, int> _codes = {
  ...
  // static final List<IconSource> _icons = List<IconSource>.generate(_codes.length, (index) => IconSource(id: _codes.keys.elementAt(index)));

  // static Map<String, int> get codes => _codes;
  // static List<IconSource> get icons => _icons;
}

class IconSource {
  IconSource({required id}): _id = id, super();

  String _id;
  // IconData? get icon => MaterializeIcon.codes[_id];
  // String get id => MdiIcons.abacus;
}